...
pyconfig=$mug_code_directory/sd_data_summaries/sd_monthly_grids_config_array.py
pyscript=$mug_code_directory/sd_data_summaries/sd_monthly_grids.py
pyhdlr=$mug_code_directory/common/process_array_output_hdlr.py
